...
let bbMemo = {
  ...
  .dark .bb-timeline .bb-item p{color:#736565;}
  ...
  function meNums(apiV1){
    ...
    fetch(bbUrl).then(res => res.json()).then( resdata =>{
      if(resdata){
        let allnums = `<div id="bb-footer"><p class="bb-allnums">共 ${resdata.length} 条 </p><p class="bb-allpub"><a href="https://memos.tjsky.net/" target="_blank">Memos Public</a></p></div>`
